...
gamepad_event_codes_set = set([
    ...
    ecodes.BTN_THUMBR,
    ecodes.BTN_WHEEL,
    ecodes.BTN_GEAR_DOWN,
    ecodes.BTN_GEAR_UP,
    ecodes.BTN_DPAD_UP,
    ecodes.BTN_DPAD_DOWN,
    ecodes.BTN_DPAD_LEFT,
    ecodes.BTN_DPAD_RIGHT,
    ecodes.BTN_TRIGGER_HAPPY,
    ecodes.BTN_TRIGGER_HAPPY1,
    ecodes.BTN_TRIGGER_HAPPY2,
    ecodes.BTN_TRIGGER_HAPPY3,
    ecodes.BTN_TRIGGER_HAPPY4,
    ecodes.BTN_TRIGGER_HAPPY5,
    ecodes.BTN_TRIGGER_HAPPY6,
    ecodes.BTN_TRIGGER_HAPPY7,
    ecodes.BTN_TRIGGER_HAPPY8,
    ecodes.BTN_TRIGGER_HAPPY9,
    ecodes.BTN_TRIGGER_HAPPY10,
    ecodes.BTN_TRIGGER_HAPPY11,
    ecodes.BTN_TRIGGER_HAPPY12,
    ecodes.BTN_TRIGGER_HAPPY13,
    ecodes.BTN_TRIGGER_HAPPY14,
    ecodes.BTN_TRIGGER_HAPPY15,
    ecodes.BTN_TRIGGER_HAPPY16,
    ecodes.BTN_TRIGGER_HAPPY17,
    ecodes.BTN_TRIGGER_HAPPY18,
    ecodes.BTN_TRIGGER_HAPPY19,
    ecodes.BTN_TRIGGER_HAPPY20,
    ecodes.BTN_TRIGGER_HAPPY21,
    ecodes.BTN_TRIGGER_HAPPY22,
    ecodes.BTN_TRIGGER_HAPPY23,
    ecodes.BTN_TRIGGER_HAPPY24,
    ecodes.BTN_TRIGGER_HAPPY25,
    ecodes.BTN_TRIGGER_HAPPY26,
    ecodes.BTN_TRIGGER_HAPPY27,
    ecodes.BTN_TRIGGER_HAPPY28,
    ecodes.BTN_TRIGGER_HAPPY29,
    ecodes.BTN_TRIGGER_HAPPY30,
    ecodes.BTN_TRIGGER_HAPPY31,
    ecodes.BTN_TRIGGER_HAPPY32,
    ecodes.BTN_TRIGGER_HAPPY33,
    ecodes.BTN_TRIGGER_HAPPY34,
    ecodes.BTN_TRIGGER_HAPPY35,
    ecodes.BTN_TRIGGER_HAPPY36,
    ecodes.BTN_TRIGGER_HAPPY37,
    ecodes.BTN_TRIGGER_HAPPY38,
    ecodes.BTN_TRIGGER_HAPPY39,
    ecodes.BTN_TRIGGER_HAPPY40])

def check_is_gamepad(capability_dict):
    available_inputs = capability_dict.get(('EV_KEY', 1))
    if available_inputs is None:
        return False
    
    for item in available_inputs:
        name = item[0] # can be str or list of str
        code = item[1] # int
        if code in gamepad_event_codes_set:
            return True
