...
#define SET3_KEY_STATE_TYPEMATIC 0
#define SET3_KEY_STATE_MAKE_BREAK 1
#define SET3_KEY_STATE_MAKE_ONLY 2

#define SET3_STATUS_LOOKUP_SIZE 142

uint8_t scancode_set3_status[SET3_STATUS_LOOKUP_SIZE] = 
{
  SET3_KEY_STATE_TYPEMATIC, // (0, 0x0), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (1, 0x1), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (2, 0x2), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (3, 0x3), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (4, 0x4), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (5, 0x5), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (6, 0x6), UNUSED
  SET3_KEY_STATE_MAKE_ONLY, // (7, 0x7), KEY_F1, (59, 0x3b)
  SET3_KEY_STATE_MAKE_ONLY, // (8, 0x8), KEY_F13, (183, 0xb7)
  SET3_KEY_STATE_TYPEMATIC, // (9, 0x9), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (10, 0xa), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (11, 0xb), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (12, 0xc), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (13, 0xd), KEY_TAB, (15, 0xf)
  SET3_KEY_STATE_TYPEMATIC, // (14, 0xe), KEY_GRAVE, (41, 0x29)
  SET3_KEY_STATE_MAKE_ONLY, // (15, 0xf), KEY_F2, (60, 0x3c)
  SET3_KEY_STATE_TYPEMATIC, // (16, 0x10), KEY_F14, (184, 0xb8)
  SET3_KEY_STATE_MAKE_BREAK, // (17, 0x11), KEY_LEFTCTRL, (29, 0x1d)
  SET3_KEY_STATE_MAKE_BREAK, // (18, 0x12), KEY_LEFTSHIFT, (42, 0x2a)
  SET3_KEY_STATE_TYPEMATIC, // (19, 0x13), KEY_102ND, (86, 0x56)
  SET3_KEY_STATE_MAKE_BREAK, // (20, 0x14), KEY_CAPSLOCK, (58, 0x3a)
  SET3_KEY_STATE_TYPEMATIC, // (21, 0x15), KEY_Q, (16, 0x10)
  SET3_KEY_STATE_TYPEMATIC, // (22, 0x16), KEY_1, (2, 0x2)
  SET3_KEY_STATE_MAKE_ONLY, // (23, 0x17), KEY_F3, (61, 0x3d)
  SET3_KEY_STATE_TYPEMATIC, // (24, 0x18), KEY_F15, (185, 0xb9)
  SET3_KEY_STATE_MAKE_BREAK, // (25, 0x19), KEY_LEFTALT, (56, 0x38)
  SET3_KEY_STATE_TYPEMATIC, // (26, 0x1a), KEY_Z, (44, 0x2c)
  SET3_KEY_STATE_TYPEMATIC, // (27, 0x1b), KEY_S, (31, 0x1f)
  SET3_KEY_STATE_TYPEMATIC, // (28, 0x1c), KEY_A, (30, 0x1e)
  SET3_KEY_STATE_TYPEMATIC, // (29, 0x1d), KEY_W, (17, 0x11)
  SET3_KEY_STATE_TYPEMATIC, // (30, 0x1e), KEY_2, (3, 0x3)
  SET3_KEY_STATE_MAKE_ONLY, // (31, 0x1f), KEY_F4, (62, 0x3e)
  SET3_KEY_STATE_TYPEMATIC, // (32, 0x20), KEY_F16, (186, 0xba)
  SET3_KEY_STATE_TYPEMATIC, // (33, 0x21), KEY_C, (46, 0x2e)
  SET3_KEY_STATE_TYPEMATIC, // (34, 0x22), KEY_X, (45, 0x2d)
  SET3_KEY_STATE_TYPEMATIC, // (35, 0x23), KEY_D, (32, 0x20)
  SET3_KEY_STATE_TYPEMATIC, // (36, 0x24), KEY_E, (18, 0x12)
  SET3_KEY_STATE_TYPEMATIC, // (37, 0x25), KEY_4, (5, 0x5)
  SET3_KEY_STATE_TYPEMATIC, // (38, 0x26), KEY_3, (4, 0x4)
  SET3_KEY_STATE_MAKE_ONLY, // (39, 0x27), KEY_F5, (63, 0x3f)
  SET3_KEY_STATE_TYPEMATIC, // (40, 0x28), KEY_F17, (187, 0xbb)
  SET3_KEY_STATE_TYPEMATIC, // (41, 0x29), KEY_SPACE, (57, 0x39)
  SET3_KEY_STATE_TYPEMATIC, // (42, 0x2a), KEY_V, (47, 0x2f)
  SET3_KEY_STATE_TYPEMATIC, // (43, 0x2b), KEY_F, (33, 0x21)
  SET3_KEY_STATE_TYPEMATIC, // (44, 0x2c), KEY_T, (20, 0x14)
  SET3_KEY_STATE_TYPEMATIC, // (45, 0x2d), KEY_R, (19, 0x13)
  SET3_KEY_STATE_TYPEMATIC, // (46, 0x2e), KEY_5, (6, 0x6)
  SET3_KEY_STATE_MAKE_ONLY, // (47, 0x2f), KEY_F6, (64, 0x40)
  SET3_KEY_STATE_TYPEMATIC, // (48, 0x30), KEY_F18, (188, 0xbc)
  SET3_KEY_STATE_TYPEMATIC, // (49, 0x31), KEY_N, (49, 0x31)
  SET3_KEY_STATE_TYPEMATIC, // (50, 0x32), KEY_B, (48, 0x30)
  SET3_KEY_STATE_TYPEMATIC, // (51, 0x33), KEY_H, (35, 0x23)
  SET3_KEY_STATE_TYPEMATIC, // (52, 0x34), KEY_G, (34, 0x22)
  SET3_KEY_STATE_TYPEMATIC, // (53, 0x35), KEY_Y, (21, 0x15)
  SET3_KEY_STATE_TYPEMATIC, // (54, 0x36), KEY_6, (7, 0x7)
  SET3_KEY_STATE_MAKE_ONLY, // (55, 0x37), KEY_F7, (65, 0x41)
  SET3_KEY_STATE_TYPEMATIC, // (56, 0x38), KEY_F19, (189, 0xbd)
  SET3_KEY_STATE_MAKE_ONLY, // (57, 0x39), KEY_RIGHTALT, (100, 0x64)
  SET3_KEY_STATE_TYPEMATIC, // (58, 0x3a), KEY_M, (50, 0x32)
  SET3_KEY_STATE_TYPEMATIC, // (59, 0x3b), KEY_J, (36, 0x24)
  SET3_KEY_STATE_TYPEMATIC, // (60, 0x3c), KEY_U, (22, 0x16)
  SET3_KEY_STATE_TYPEMATIC, // (61, 0x3d), KEY_7, (8, 0x8)
  SET3_KEY_STATE_TYPEMATIC, // (62, 0x3e), KEY_8, (9, 0x9)
  SET3_KEY_STATE_MAKE_ONLY, // (63, 0x3f), KEY_F8, (66, 0x42)
  SET3_KEY_STATE_TYPEMATIC, // (64, 0x40), KEY_F20, (190, 0xbe)
  SET3_KEY_STATE_TYPEMATIC, // (65, 0x41), KEY_COMMA, (51, 0x33)
  SET3_KEY_STATE_TYPEMATIC, // (66, 0x42), KEY_K, (37, 0x25)
  SET3_KEY_STATE_TYPEMATIC, // (67, 0x43), KEY_I, (23, 0x17)
  SET3_KEY_STATE_TYPEMATIC, // (68, 0x44), KEY_O, (24, 0x18)
  SET3_KEY_STATE_TYPEMATIC, // (69, 0x45), KEY_0, (11, 0xb)
  SET3_KEY_STATE_TYPEMATIC, // (70, 0x46), KEY_9, (10, 0xa)
  SET3_KEY_STATE_MAKE_ONLY, // (71, 0x47), KEY_F9, (67, 0x43)
  SET3_KEY_STATE_TYPEMATIC, // (72, 0x48), KEY_F21, (191, 0xbf)
  SET3_KEY_STATE_TYPEMATIC, // (73, 0x49), KEY_DOT, (52, 0x34)
  SET3_KEY_STATE_TYPEMATIC, // (74, 0x4a), KEY_KPSLASH, (98, 0x62)
  SET3_KEY_STATE_TYPEMATIC, // (75, 0x4b), KEY_L, (38, 0x26)
  SET3_KEY_STATE_TYPEMATIC, // (76, 0x4c), KEY_SEMICOLON, (39, 0x27)
  SET3_KEY_STATE_TYPEMATIC, // (77, 0x4d), KEY_P, (25, 0x19)
  SET3_KEY_STATE_TYPEMATIC, // (78, 0x4e), KEY_KPMINUS, (74, 0x4a)
  SET3_KEY_STATE_MAKE_ONLY, // (79, 0x4f), KEY_F10, (68, 0x44)
  SET3_KEY_STATE_TYPEMATIC, // (80, 0x50), KEY_F22, (192, 0xc0)
  SET3_KEY_STATE_TYPEMATIC, // (81, 0x51), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (82, 0x52), KEY_APOSTROPHE, (40, 0x28)
  SET3_KEY_STATE_TYPEMATIC, // (83, 0x53), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (84, 0x54), KEY_LEFTBRACE, (26, 0x1a)
  SET3_KEY_STATE_TYPEMATIC, // (85, 0x55), KEY_EQUAL, (13, 0xd)
  ...
  SET3_KEY_STATE_TYPEMATIC, // (90, 0x5a), KEY_ENTER, (28, 0x1c)
  SET3_KEY_STATE_TYPEMATIC, // (91, 0x5b), KEY_RIGHTBRACE, (27, 0x1b)
  SET3_KEY_STATE_TYPEMATIC, // (92, 0x5c), KEY_BACKSLASH, (43, 0x2b)
  SET3_KEY_STATE_TYPEMATIC, // (93, 0x5d), UNUSED
  SET3_KEY_STATE_MAKE_ONLY, // (94, 0x5e), KEY_F12, (88, 0x58)
  SET3_KEY_STATE_MAKE_ONLY, // (95, 0x5f), KEY_F24, (194, 0xc2)
  SET3_KEY_STATE_TYPEMATIC, // (96, 0x60), KEY_DOWN, (108, 0x6c)
  SET3_KEY_STATE_TYPEMATIC, // (97, 0x61), KEY_LEFT, (105, 0x69)
  SET3_KEY_STATE_MAKE_ONLY, // (98, 0x62), KEY_PAUSE, (119, 0x77)
  SET3_KEY_STATE_TYPEMATIC, // (99, 0x63), KEY_UP, (103, 0x67)
  SET3_KEY_STATE_TYPEMATIC, // (100, 0x64), KEY_DELETE, (111, 0x6f)
  SET3_KEY_STATE_MAKE_ONLY, // (101, 0x65), KEY_END, (107, 0x6b)
  SET3_KEY_STATE_TYPEMATIC, // (102, 0x66), KEY_BACKSPACE, (14, 0xe)
  SET3_KEY_STATE_MAKE_ONLY, // (103, 0x67), KEY_INSERT, (110, 0x6e)
  SET3_KEY_STATE_TYPEMATIC, // (104, 0x68), UNUSED
  SET3_KEY_STATE_MAKE_ONLY, // (105, 0x69), KEY_KP1, (79, 0x4f)
  SET3_KEY_STATE_TYPEMATIC, // (106, 0x6a), KEY_RIGHT, (106, 0x6a)
  ...
  SET3_KEY_STATE_TYPEMATIC, // (120, 0x78), UNUSED
  SET3_KEY_STATE_MAKE_ONLY, // (121, 0x79), KEY_KPENTER, (96, 0x60)
  SET3_KEY_STATE_MAKE_ONLY, // (122, 0x7a), KEY_KP3, (81, 0x51)
  SET3_KEY_STATE_TYPEMATIC, // (123, 0x7b), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (124, 0x7c), KEY_KPPLUS, (78, 0x4e)
  SET3_KEY_STATE_MAKE_ONLY, // (125, 0x7d), KEY_KP9, (73, 0x49)
  SET3_KEY_STATE_MAKE_ONLY, // (126, 0x7e), KEY_KPASTERISK, (55, 0x37)
  SET3_KEY_STATE_TYPEMATIC, // (127, 0x7f), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (128, 0x80), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (129, 0x81), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (130, 0x82), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (131, 0x83), UNUSED
  SET3_KEY_STATE_MAKE_ONLY, // (132, 0x84), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (133, 0x85), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (134, 0x86), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (135, 0x87), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (136, 0x88), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (137, 0x89), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (138, 0x8a), UNUSED
  SET3_KEY_STATE_TYPEMATIC, // (139, 0x8b), KEY_LEFTMETA, (125, 0x7d)
  SET3_KEY_STATE_TYPEMATIC, // (140, 0x8c), KEY_RIGHTMETA, (126, 0x7e)
  SET3_KEY_STATE_TYPEMATIC, // (141, 0x8d), KEY_COMPOSE, (127, 0x7f)
};
