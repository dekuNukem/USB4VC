...
#define M0110A_CLK_HI() HAL_GPIO_WritePin(M0110_CLK_GPIO_Port, M0110_CLK_Pin, GPIO_PIN_SET)
#define M0110A_CLK_LOW() HAL_GPIO_WritePin(M0110_CLK_GPIO_Port, M0110_CLK_Pin, GPIO_PIN_RESET)

#define M0110A_DATA_HI() HAL_GPIO_WritePin(M0110_DATA_GPIO_Port, M0110_DATA_Pin, GPIO_PIN_SET)
#define M0110A_DATA_LOW() HAL_GPIO_WritePin(M0110_DATA_GPIO_Port, M0110_DATA_Pin, GPIO_PIN_RESET)

#define M0110A_READ_DATA_PIN() HAL_GPIO_ReadPin(M0110_DATA_GPIO_Port, M0110_DATA_Pin)
#define M0110A_READ_CLK_PIN() HAL_GPIO_ReadPin(M0110_CLK_GPIO_Port, M0110_CLK_Pin)
...
uint8_t m0110a_get_line_status(void)
{
  ...
  {
    if(HAL_GPIO_ReadPin(M0110_DATA_GPIO_Port, M0110_DATA_Pin))
...
uint8_t wait_for_data_idle(uint16_t timeout_ms)
{
	...
	while(1)
	{
		...
		if(HAL_GPIO_ReadPin(M0110_DATA_GPIO_Port, M0110_DATA_Pin) == GPIO_PIN_SET)
			break;
	}
	return M0110A_OK;
}
